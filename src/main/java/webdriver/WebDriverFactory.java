...
public class WebDriverFactory {
     ...
     */
    public static WebDriver getInstance(String gridHubUrl, Browser browser) throws MalformedURLException {

        DesiredCapabilities capability = new DesiredCapabilities();
        String browserName = browser.getName();
        capability.setJavascriptEnabled(true);

        WebDriver driver = null; // // change to
        //  "http://127.0.0.1:4444/wd/hub";// to // java -jar selenium-server-standalone-2.48.2.jar
